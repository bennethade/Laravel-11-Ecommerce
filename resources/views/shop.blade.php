                        ...
                        @foreach ($categories as $category)
                            <li class="list-item">
                                <span class="menu-link py-1">
                                    <input type="checkbox" class="chk-category" name="categories" id="" value="{{ $category->id }}"
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    @foreach (explode(',',$product->images) as $gimg)
                                        <a href="{{ route('shop.product.details', $product->slug) }}"><img loading="lazy" src="{{ asset('uploads/products/') }}/{{ $gimg }}" width="330" height="400" alt="{{ $product->image }}" class="pc__img"></a>
                                    @endforeach
                                </div>
                            </div>
...
@push('scripts')
    <script>
        $(function() {
            // FOR PAGE ORDERING BY NUMBER
            $("#pagesize").on("change", function(){
                $("#size").val($("#pagesize option:selected").val());
                $("#frmfilter").submit();
            });

            // FOR PAGE ORDERING BY DATE AND PRICE
