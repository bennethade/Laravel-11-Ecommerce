                    ...
                    <div class="swiper-slide product-card">
                        <div class="pc__img-wrapper">
                            ...
                            @else
                                <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                                    @csrf
                                    <input type="hidden" name="id" id="" value="{{ $rproduct->id }}">
                                    <input type="hidden" name="quantity" id="" value="1">
                                    <input type="hidden" name="name" id="" value="{{ $rproduct->name }}">
                                    <input type="hidden" name="price" id="" value="{{ $rproduct->sale_price == '' ? $rproduct->regular_price : $rproduct->sale_price }}">
