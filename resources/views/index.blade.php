                  ...
                  @foreach ($onSaleProducts as $onSaleProduct)
                    <div class="swiper-slide product-card product-card_style3">
                      <div class="pc__img-wrapper">
                        <a href="{{ route('shop.product.details', ['product_slug'=>$onSaleProduct->slug]) }}">
                          <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $onSaleProduct->image }}" width="258" height="313" alt="{{ $onSaleProduct->name }}" class="pc__img">
                        </a>
                      </div>

                      <div class="pc__info position-relative">
                        <h6 class="pc__title"><a href="{{ route('shop.product.details', ['product_slug'=>$onSaleProduct->slug]) }}">{{ $onSaleProduct->name }}</a></h6>
                        <div class="product-card__price d-flex">
                          <span class="money price text-secondary">
                            @if ($onSaleProduct->sale_price)
                                <s>${{ $onSaleProduct->regular_price }}</s> ${{ $onSaleProduct->sale_price }} 
                            @else
                                ${{ $onSaleProduct->regular_price }}
                            @endif
                          </span>
                        </div>
                      </div>
          ...
          @foreach ($featuredProducts as $featuredProduct)
            <div class="col-6 col-md-4 col-lg-3">
              <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                ...
                <div class="pc__info position-relative">
                  <h6 class="pc__title"><a href="details.html">{{ $featuredProduct->name }}</a></h6>
