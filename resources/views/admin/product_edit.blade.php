...
@section('content')
    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- form-add-product -->
            <form action="{{ route('admin.product.update') }}" class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="wg-box">
                    <fieldset>
                        <div class="body-title">Upload Product Image <span class="tf-color-1">*</span>
                        </div>
